...
async def restart_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # শুধু প্রসেসটি বন্ধ করুন। ওয়াচডগ বাকিটা সামলে নেবে।
    sys.exit()

# ... (get_link, add_admin, remove_admin, list_admins ফাংশনগুলো অপরিবর্তিত) ...
...
# ... (Flask routes এবং অন্যান্য ফাংশন অপরিবর্তিত) ...
